...
(function(root){
	...
	function WarmSpacesFinder(opts){
		...
		function formatSource(source,entry){
			...
			html += ' / <a href="mailto:hello@open-innovations.org?subject=Complaints and Reports&body=Use this email to report wrong or harmful content on the Warm Spaces Finder. Note that the warm space finder is a search tool that gets results from directories maintained by local councils and community groups. The specific warm space offer comes from a directory maintained by '+(source.title)+' ('+source.url+') so you should also report any complaints to them.%0d%0a%0d%0aDirectory: '+source.title+'%0d%0a%0d%0aTitle: '+entry.title.replace(/"/g,'\'')+'%0d%0a%0d%0aThe nature of the complaint:%0d%0a%0d%0aI wish to be contacted about this report: Yes/No%0d%0a%0d%0aBy sending this email you are covered by our Privacy Policy which can be found at https://open-innovations.org/privacy">Report</a>'
